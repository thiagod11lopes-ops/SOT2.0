...
const homeTableHeadClass =
  "font-bold text-[hsl(var(--primary))] text-[clamp(0.4125rem,0.24rem+0.75cqi,0.6375rem)] leading-[1.32] [text-shadow:0_1px_2px_rgba(0,0,0,0.42),0_2px_8px_rgba(0,0,0,0.32)]";
